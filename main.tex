...
% Main title
\title [mode = title]{A Graph-Based and Metaheuristic Approach to the 2D Shortest Superstring Problem}
...
\end{itemize}
This construction guarantees that the translated $B_2$ and $B_1$ share a common edge, making the combined region 4-connected.
...
Let $\mathcal{T}$ be an instance of 2D-SSP (either 2D-SSP$_{\mathrm{area}}$ or 2D-SSP$_{\square}$), and let $p^*$ be an optimal
...
\toprule
\textbf{Config} & \texttt{greedy} & \texttt{stochastic\_greedy} & \texttt{genetic\_greedy} & \texttt{genetic\_stochastic} \\
\midrule
T6\_n3\_m3 & \shortstack{$43.80$\\$\left(0.002\mathrm{s}\right)$} & \shortstack{$43.80$\\$\left(\mathbf{0.002}\mathrm{s}\right)$} & \shortstack{$41.50$\\$\left(0.111\mathrm{s}\right)$} & \shortstack{$\mathbf{40.60}$\\$\left(0.154\mathrm{s}\right)$} \\
T6\_n5\_m5 & \shortstack{$144.00$\\$\left(\mathbf{0.025}\mathrm{s}\right)$} & \shortstack{$143.00$\\$\left(0.027\mathrm{s}\right)$} & \shortstack{$143.00$\\$\left(0.491\mathrm{s}\right)$} & \shortstack{$\mathbf{142.50}$\\$\left(1.066\mathrm{s}\right)$} \\
T6\_n10\_m10 & \shortstack{$599.00$\\$\left(2.722\mathrm{s}\right)$} & \shortstack{$599.00$\\$\left(\mathbf{2.697}\mathrm{s}\right)$} & \shortstack{$\mathbf{598.00}$\\$\left(25.851\mathrm{s}\right)$} & \shortstack{$\mathbf{598.00}$\\$\left(44.959\mathrm{s}\right)$} \\
T8\_n3\_m3 & \shortstack{$57.10$\\$\left(\mathbf{0.003}\mathrm{s}\right)$} & \shortstack{$58.10$\\$\left(0.004\mathrm{s}\right)$} & \shortstack{$53.90$\\$\left(0.149\mathrm{s}\right)$} & \shortstack{$\mathbf{51.80}$\\$\left(0.162\mathrm{s}\right)$} \\
T8\_n5\_m5 & \shortstack{$195.20$\\$\left(0.053\mathrm{s}\right)$} & \shortstack{$196.20$\\$\left(\mathbf{0.053}\mathrm{s}\right)$} & \shortstack{$190.50$\\$\left(0.847\mathrm{s}\right)$} & \shortstack{$\mathbf{190.00}$\\$\left(2.472\mathrm{s}\right)$} \\
T8\_n10\_m10 & \shortstack{$799.00$\\$\left(5.962\mathrm{s}\right)$} & \shortstack{$799.00$\\$\left(\mathbf{5.953}\mathrm{s}\right)$} & \shortstack{$\mathbf{798.00}$\\$\left(64.985\mathrm{s}\right)$} & \shortstack{$\mathbf{798.00}$\\$\left(103.970\mathrm{s}\right)$} \\
T10\_n3\_m3 & \shortstack{$69.20$\\$\left(0.005\mathrm{s}\right)$} & \shortstack{$69.10$\\$\left(\mathbf{0.005}\mathrm{s}\right)$} & \shortstack{$62.30$\\$\left(0.195\mathrm{s}\right)$} & \shortstack{$\mathbf{59.00}$\\$\left(0.266\mathrm{s}\right)$} \\
T10\_n5\_m5 & \shortstack{$240.00$\\$\left(\mathbf{0.089}\mathrm{s}\right)$} & \shortstack{$241.00$\\$\left(0.089\mathrm{s}\right)$} & \shortstack{$237.00$\\$\left(1.530\mathrm{s}\right)$} & \shortstack{$\mathbf{236.00}$\\$\left(4.976\mathrm{s}\right)$} \\
T10\_n10\_m10 & \shortstack{$999.00$\\$\left(11.122\mathrm{s}\right)$} & \shortstack{$999.00$\\$\left(\mathbf{11.091}\mathrm{s}\right)$} & \shortstack{$\mathbf{998.00}$\\$\left(114.693\mathrm{s}\right)$} & \shortstack{$\mathbf{998.00}$\\$\left(184.834\mathrm{s}\right)$} \\
T50\_n3\_m3 & \shortstack{$227.30$\\$\left(\mathbf{0.086}\mathrm{s}\right)$} & \shortstack{$236.60$\\$\left(0.097\mathrm{s}\right)$} & \shortstack{$197.90$\\$\left(13.097\mathrm{s}\right)$} & \shortstack{$\mathbf{191.33}$\\$\left(18.018\mathrm{s}\right)$} \\
T60\_n3\_m3 & \shortstack{$278.70$\\$\left(\mathbf{0.152}\mathrm{s}\right)$} & \shortstack{$283.60$\\$\left(0.164\mathrm{s}\right)$} & \shortstack{$223.30$\\$\left(28.947\mathrm{s}\right)$} & \shortstack{$\mathbf{220.20}$\\$\left(35.860\mathrm{s}\right)$} \\
T80\_n3\_m3 & \shortstack{$349.40$\\$\left(\mathbf{0.196}\mathrm{s}\right)$} & \shortstack{$347.90$\\$\left(0.196\mathrm{s}\right)$} & \shortstack{$\mathbf{268.20}$\\$\left(54.356\mathrm{s}\right)$} & \shortstack{$270.40$\\$\left(57.364\mathrm{s}\right)$} \\
T100\_n3\_m3 & \shortstack{$414.30$\\$\left(\mathbf{0.337}\mathrm{s}\right)$} & \shortstack{$421.70$\\$\left(0.358\mathrm{s}\right)$} & \shortstack{$\mathbf{306.20}$\\$\left(122.176\mathrm{s}\right)$} & \shortstack{$311.30$\\$\left(114.786\mathrm{s}\right)$} \\
\bottomrule
\end{tabular*}
...
\toprule
\textbf{Config} & \texttt{cplex} & \texttt{greedy} & \texttt{stochastic\_greedy} & \texttt{genetic\_greedy} & \texttt{genetic\_stochastic} \\
\midrule
T20\_n3\_m3 & \shortstack{$120.30$\\$\left(2005.749\mathrm{s}\right)$} & \shortstack{$120.30$\\$\left(\mathbf{0.010}\mathrm{s}\right)$} & \shortstack{$122.60$\\$\left(0.013\mathrm{s}\right)$} & \shortstack{$104.20$\\$\left(1.041\mathrm{s}\right)$} & \shortstack{$\mathbf{96.10}$\\$\left(1.628\mathrm{s}\right)$} \\
T30\_n3\_m3 & \shortstack{$340.90$\\$\left(2021.541\mathrm{s}\right)$} & \shortstack{$154.70$\\$\left(\mathbf{0.021}\mathrm{s}\right)$} & \shortstack{$164.80$\\$\left(0.024\mathrm{s}\right)$} & \shortstack{$138.40$\\$\left(2.821\mathrm{s}\right)$} & \shortstack{$\mathbf{131.90}$\\$\left(3.518\mathrm{s}\right)$} \\
\bottomrule
\end{tabular*}
\caption{Objective type: \texttt{area}. Each cell shows objective (top) as mean $\pm$ std and runtime is mean only (bottom).}
\label{tab:results-summary-cplex}
\end{table}
...
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}}cccccc}
\toprule
\textbf{Config} & \texttt{merge\_greedy\_py} & \texttt{greedy} & \texttt{stochastic\_greedy} & \texttt{genetic\_greedy} & \texttt{genetic\_stochastic} \\
\midrule
T10\_n1\_m8 & \shortstack{$46.10$\\$\left(\mathbf{0.001}\mathrm{s}\right)$} & \shortstack{$49.50$\\$\left(0.007\mathrm{s}\right)$} & \shortstack{$48.20$\\$\left(0.007\mathrm{s}\right)$} & \shortstack{$45.30$\\$\left(0.288\mathrm{s}\right)$} & \shortstack{$\mathbf{44.80}$\\$\left(0.400\mathrm{s}\right)$} \\
T20\_n1\_m8 & \shortstack{$73.80$\\$\left(\mathbf{0.004}\mathrm{s}\right)$} & \shortstack{$77.00$\\$\left(0.025\mathrm{s}\right)$} & \shortstack{$77.30$\\$\left(0.045\mathrm{s}\right)$} & \shortstack{$74.00$\\$\left(0.880\mathrm{s}\right)$} & \shortstack{$\mathbf{71.40}$\\$\left(1.416\mathrm{s}\right)$} \\
T50\_n1\_m8 & \shortstack{$\mathbf{123.50}$\\$\left(\mathbf{0.048}\mathrm{s}\right)$} & \shortstack{$135.10$\\$\left(0.148\mathrm{s}\right)$} & \shortstack{$136.50$\\$\left(0.191\mathrm{s}\right)$} & \shortstack{$131.30$\\$\left(7.273\mathrm{s}\right)$} & \shortstack{$127.10$\\$\left(6.853\mathrm{s}\right)$} \\
T100\_n1\_m8 & \shortstack{$\mathbf{176.50}$\\$\left(\mathbf{0.276}\mathrm{s}\right)$} & \shortstack{$198.50$\\$\left(0.399\mathrm{s}\right)$} & \shortstack{$196.10$\\$\left(0.380\mathrm{s}\right)$} & \shortstack{$185.10$\\$\left(25.846\mathrm{s}\right)$} & \shortstack{$183.40$\\$\left(25.341\mathrm{s}\right)$} \\
T200\_n1\_m8 & \shortstack{$\mathbf{227.80}$\\$\left(1.201\mathrm{s}\right)$} & \shortstack{$258.10$\\$\left(0.956\mathrm{s}\right)$} & \shortstack{$252.90$\\$\left(\mathbf{0.880}\mathrm{s}\right)$} & \shortstack{$242.30$\\$\left(100.015\mathrm{s}\right)$} & \shortstack{$238.00$\\$\left(126.543\mathrm{s}\right)$} \\
T300\_n1\_m8 & \shortstack{$\mathbf{251.70}$\\$\left(2.533\mathrm{s}\right)$} & \shortstack{$280.50$\\$\left(1.390\mathrm{s}\right)$} & \shortstack{$278.80$\\$\left(\mathbf{1.353}\mathrm{s}\right)$} & \shortstack{$262.80$\\$\left(279.432\mathrm{s}\right)$} & \shortstack{$258.30$\\$\left(332.637\mathrm{s}\right)$} \\
\bottomrule
\end{tabular*}
\caption{Objective type: \texttt{area}. Each cell shows objective (top) as mean $\pm$ std and runtime is mean only (bottom).}
\label{tab:results-summary-merge}
\end{table}
...
% Figure commented out - image file not found
% \begin{figure}[H] 
%     \centering
%     \includegraphics[width=1.0\linewidth]{figs/Comparee.png}
